...
function pageTdcApproveList() {
      ...
      <tr>
        ...
        <td style="width: 220px; min-width: 220px; text-align: center;">
          <div style="display: flex; align-items: center; justify-content: center; gap: 8px;">
            <button class="btn btn-sm btn-primary" data-action="tdc-approve-modal" data-rf="${esc(r.rf)}" style="white-space: nowrap;">${iconCheck()} อนุมัติ</button>
            <button class="btn btn-sm btn-danger-ghost" data-action="tdc-reject-modal" data-rf="${esc(r.rf)}" style="white-space: nowrap;">${iconX()} ไม่อนุมัติ</button>
            <button class="btn btn-sm btn-secondary" data-action="tdc-view-detail" data-rf="${esc(r.rf)}" style="white-space: nowrap;">ดู</button>
          </div>
        </td>
      </tr>`;
  ...
  return `
    <div class="page-head" style="display:flex; justify-content:space-between; align-items:flex-start;">
      ...
      <button class="btn btn-secondary btn-excel" data-action="tdc-export" style="display:flex; align-items:center; gap:6px;">
...
function pageTdcApproveDetail(rfId) {
  ...
  return `
    ...
    ${r.percentApprovalStatus === 'rejected' && r.rejectReason ? `
